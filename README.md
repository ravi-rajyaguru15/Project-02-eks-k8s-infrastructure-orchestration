...
- **Project 1**: Multi-service containerization and deployment using Docker Compose on AWS EC2  (https://github.com/ravi-rajyaguru15/Project-01-dockerized-multi-service-application)
